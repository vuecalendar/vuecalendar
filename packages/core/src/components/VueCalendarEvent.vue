<template>
    ...
    >
        ...
        >
            <div class="vuecalendar-event__header">
                <span class="vuecalendar-event__title">{{ event.title }}</span>
                <svg
                    v-if="event.locked"
            ...
            <div v-if="eventHeight > 40" class="vuecalendar-event__time">
                <svg class="vuecalendar-event__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div v-if="eventHeight > 64 && event.description" class="vuecalendar-event__desc">
                <svg class="vuecalendar-event__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
